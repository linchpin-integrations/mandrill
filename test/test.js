...
describe('stripe',function(){
    ...
    describe('process_hook',function(){
        it('should process mandrill events',function(done){
            var req =  {lpi:'mandrill', cmd:'process_hook', config:{name:"test"}, env:{
                headers:["Connection: close",
                    "X-Mandrill-Signature: NSPjFFk3YPLYz9KBCp7/hzdTGB4=",
                    "Accept: */*",
                    "Content-Type: application/x-www-form-urlencoded",
                    "Connect-Time: 1",
                    "X-Request-Id: 674da7c5-d4f1-455a-b759-257cd5b1f836",
                    "Total-Route-Time: 0",
                    "Via: 1.1 vegur",
                    "Host: requestb.in",
